...
function init(pool, cb) {
    pool.connect((err, client, release) => {
        ...
        client.query(`
            ...
            CREATE TABLE address (id SERIAL, text TEXT, _text TEXT, number INT, lon TEXT, lat TEXT, geom GEOMETRY(POINTZ, 4326));
...
function optimize(pool, cb) {
    pool.connect((err, client, release) => {
        ...
        client.query(`
            ...
            UPDATE network SET geom = ST_SetSRID(ST_MakePoint(lon::NUMERIC, lat::NUMERIC, number), 4326);
