...
function index(pool, stream, type, opts, cb) {
    ...
    function createRL(client, release) {
        ...
        rl.on('line', function(line) {
            ...
            ql = ql + "INSERT INTO "+type+" (id, text, data) VALUES ("+ ++insertID +",'" + str + "','" + line + "');";
        ...
        rl.on('close', function() {
            if (insertID !== 0) client.query("COMMIT");

            client.query('CREATE INDEX text_idx ON '+type+' (text);', function() {
                release();
