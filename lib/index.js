    ...
    pool.connect((err, client, release) => {
        ...
        rl.on('line', function(line) {
            ...
            if (type === 'address') {
                ...
                rl.output.write(`${feat.properties.street}|${feat.properties._text}|${JSON.stringify(feat.geometry)}|${feat.properties.number}\n`);
            } else {
                rl.output.write(`${feat.properties.street}|${feat.properties._text}|${JSON.stringify(feat.geometry)}\n`);
            }
        });
