...
function interpolize(street, address, argv) {
    ...
    for (var dist_it = 0; dist_it < distStart.length; dist_it++) {
    ...
    for (var dist_it = 0; dist_it < distEnd.length; dist_it++) {
        if (distStart[dist_it].distOnLine - streetDist !== 0 && !result.lend && distEnd[dist_it].side === leftSide) {
            result.lend = distEnd[dist_it].number;
        } else if (distStart[dist_it].distOnLine - streetDist !== 0 && !result.rend && distEnd[dist_it].side !== leftSide) {
