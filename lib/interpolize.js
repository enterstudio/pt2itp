...
function interpolize(street, address, argv) {
    ...
    street.properties = {
        "carmen:text": street.properties['carmen:text'],
        "carmen:lparity": lparity,
        "carmen:lstart": result.lstart,
        "carmen:lend":   result.lend,
        "carmen:rparity": rparity,
        "carmen:rstart": result.rstart,
        "carmen:rend":   result.rend,
        "carmen:center": turf.centroid(street).geometry.coordinates.join(','),
