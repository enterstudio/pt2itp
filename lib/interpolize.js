...
function interpolize(street, address, argv) {
    ...
    if (!argv.country) argv.country = false;
    ...
    var distStart = _.cloneDeep(dist.sort((a, b) => {
    ...
    var distEnd = _.cloneDeep(dist.sort((a, b) => {
    ...
    if (argv.country) street.properties['carmen:geocoder_stack'] = argv.country;
