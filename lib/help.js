module.exports = function(argv) {
    switch (argv._[2]) {
        case ('test'):
            console.log('usage: index.js test [--addresses=<FILE.geojson>] [--itp=<FILE.geojson>] [--debug]');
            console.log('');
            console.log('[options]:');
            ...
            console.log('   --debug                       Print the problematic addresses to STDOUT');
            break;
        case ('name'):
            ...
            break;
        case ('map'):
            console.log('usage: index.js map [--in-network=<FILE.mbtiles>] [--in-address=<FILE.mbtiles>] [--output=<FILE.mbtiles>]');
            console.log('');
            console.log('[options]:');
            console.log('   --in-network=<FILE.mbtiles>     mbtiles of street network');
            console.log('   --in-address=<FILE.mbtiles>     mbtiles of address points');
